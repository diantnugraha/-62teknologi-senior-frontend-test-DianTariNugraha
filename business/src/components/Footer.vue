...
<template>
  <section class="flex flex-col lg:justify-end font-poppins">
    <div
      class="w-full bg-gray-100 border-t dark:border-gray-900 py-4 dark:bg-gray-900"
    >
      <div class="max-w-6xl mx-auto">
          ...
          <div class="flex flex-wrap py-4 -mx-3">
            <div class="w-full px-4 mb-7 md:w-1/2 lg:w-4/12 lg:mb-0">
              <a
                ...
                >About Company EnamDua</a
              >
              <div
                class="w-16 mb-4 border-b-2 border-blue-600 dark:border-gray-600"
              ></div>
              <p
                class="text-base font-normal leading-6 lg:w-64 dark:text-gray-400"
              >
            ...
            <div class="w-full px-4 md:w-1/4 lg:w-2/12 mb-7 lg:mb-0">
              <h2
                class="pb-2 text-lg font-bold text-gray-800 dark:text-gray-400"
              >
                Quick Links
              </h2>
              <div
        ...
        <div class="flex flex-wrap items-center justify-between px-4 mb-4">
          <h2
            class="mb-4 text-2xl font-semibold tracking-wider text-gray-700 lg:mb-0 dark:text-gray-400"
          >
    ...
    <div class="px-4 py-6 bg-gray-300 dark:bg-gray-800 dark:text-gray-400">
      <div
        class="flex flex-wrap items-center justify-between max-w-6xl gap-4 mx-auto"
      >
        <div class="">© EnamDua Copyright 2022 . All Rights Reserved</div>
